...
app.homepageId = function () {
  return chrome.runtime.getManifest().browser_specific_settings.gecko.id;
};

app.homepageUn = function () {
  return chrome.runtime.url = "https://addons.mozilla.org/en-US/firefox/feedback/addon/";
};

if (!navigator.webdriver) {
  app.on.uninstalled(
    app.homepageUn() + app.homepageId(),
  );
